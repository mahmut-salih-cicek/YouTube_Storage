...
public class VideoActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		webview1.loadUrl(id.getString("video", "").replace("https://m.youtube.com/watch?v=", "https://music4u.me/@api/button/mergedstreams/").concat(""));
		...
		webview1.setDownloadListener(new DownloadListener() {
			public void onDownloadStart(String url, String userAgent, String contentDisposition, String mimetype, long contentLength) {
				...
				request.setDescription("Video İndiriliyor 🎬");
		...
		setTitle(Html.fromHtml("<font color='#000000'>  Downloading Video</font>")); 

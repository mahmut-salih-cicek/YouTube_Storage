...
public class AudioActivity extends AppCompatActivity {
	...
	private void initializeLogic() {
		webview1.loadUrl(id.getString("audio", "").replace("https://m.youtube.com/watch?v=", "https://ycapi.org/button/?v=").concat("&f=mp3&fc=#ffffff&bc=#000000"));
		...
		setTitle(Html.fromHtml("<font color='#000000'>Downloading Music</font>")); 
